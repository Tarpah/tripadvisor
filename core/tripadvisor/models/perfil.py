...
class Perfil(BaseModel):
    ...
    data_nascimento = models.DateField(validators=[verifica_maior_idade])
    ...
    membro_desde = models.DateField(auto_now_add=True) # fiquei em dúvida entre um default e deixar auto_now_add=True
